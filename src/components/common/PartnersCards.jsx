                    ...
                    {mapdata.map((obj, i) => (
                        <SwiperSlide key={i} className='h-full'>
                            <div
                                ...
                                className='bg-white h-full rounded-xl flex flex-col h-full overflow-clip'
                            >
                                ...
                                <div className='bg-[#FF0004] h-full py-3 px-2.5'>
                                    <p className='text-white line-clamp-2 overflow-clip ff_n text-base md:text-lg font-bold leading-[150%]'>
                                        {obj.title}
                                    </p>
                                </div>
                            </div>
